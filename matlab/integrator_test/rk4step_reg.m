...
blob1.th = blob.th + 0.5*step*dthdt_reg(blob,dv);
...
blob2.th = blob.th + 0.5*step*dthdt_reg(blob1,dv1);
...
blob3.th = blob.th + step*dthdt_reg(blob2,dv2);
...
blob4.th = blob.th + step*...
    (dthdt_reg(blob,dv) + 2*dthdt_reg(blob1,dv1)+...
    2*dthdt_reg(blob2,dv2) + dthdt_reg(blob3,dv3))/6;
