function blob = ab4step(blob1,blob2,blob3,blob4,step,visc)
...
blob.th = blob1.th + step/24*...
    (55*dthdt(blob1,dv1)-59*dthdt(blob2,dv2)+...
    37*dthdt(blob3,dv3)-9*dthdt(blob4,dv4));
